...
- Seed de demo: la primera corrida real contra Supabase local (Docker) sigue pendiente —
  checklist en `docs/demo.md`; los tokens de asignaciones pendientes solo se imprimen en la
  primera corrida (re-sembrar requiere `db reset`).
